...
def information_gain_positive(cell):
...
def information_gain(cell):
    PrFC = ig_factor(cell.p_tp(), cell.p_f(), cell.p_c())
    PrFnC = ig_factor(cell.p_fp(), cell.p_f(), cell.p_not_c())
    PrnFC = ig_factor(cell.p_fn(), cell.p_not_f(), cell.p_c())
    PrnFnC = ig_factor(cell.p_tn(), cell.p_not_f(), cell.p_not_c())
    return PrFC + PrFnC + PrnFC + PrnFnC
